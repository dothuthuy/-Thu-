    ...
    public class HeThongPhanPhoiController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var heThongPhanPhoi = await _context.HeThongPhanPhoi
                .FirstOrDefaultAsync(m => m.MaHTTPP == id);
        ...
        public async Task<IActionResult> Create([Bind("MaHTTPP,TenHTPP")] HeThongPhanPhoi heThongPhanPhoi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaHTTPP,TenHTPP")] HeThongPhanPhoi heThongPhanPhoi)
        {
            if (id != heThongPhanPhoi.MaHTTPP)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!HeThongPhanPhoiExists(heThongPhanPhoi.MaHTTPP))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.HeThongPhanPhoi.Any(e => e.MaHTTPP == id);
        }
    }
}
