...
namespace DoThuThuy.Controllers
{
    public class DaiLyController : Controller
    {
        ...
        public DaiLyController(LTQLDb context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaDaiLy,TenDaiLy,DiaChi,NguoiDaiDien,MaHTPP")] DaiLy daiLy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaDaiLy,TenDaiLy,DiaChi,NguoiDaiDien,MaHTPP")] DaiLy daiLy)
        {
            if (id != daiLy.MaDaiLy)
            {
                return NotFound();
